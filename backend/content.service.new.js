...
const AppError = require('./windscribe-backend/src/utils/appError');
...
exports.generateMultipleContent = async (category, user, contentType, count = 10, difficulty = 'beginner', model = 'gpt-4-turbo-preview') => {
  ...
  let promptStrategy;
  try {
    const promptText = getPromptForCategoryAndType(fullCategory.name, effectiveContentType);
    promptStrategy = {
    ...
    console.log(`Using content type: ${effectiveContentType}, generating ${count} items`);
  } catch (error) {
